// carne - 400 gr por pessoa até 6 horas mais que isso 650 gramas
// carne mulher 300 gr até 6 horas mais que isso 550 gr
// cerveja - 1200 ml por pessoa até 6 horas mais que isso 2000ml
// refrigerante/agua - 1000ml por pessoa até 6 horas mais que isso 1500ml

// crianças valem por 0,5 pessoas.
...
function recuperarValoresChurrasco() {
    ...
    for (let i = 0; i < inputs.length; i++) {
        ...
        if (inputValue === '') {
            ...
            alert(`${inputName} nÃ£o pode estar vazio`)
            return
        }
